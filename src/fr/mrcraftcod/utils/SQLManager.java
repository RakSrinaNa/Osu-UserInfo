...
{
	public static final String TABLE = "OsuUserInfo", CREATE_TABLE_PLAYERS = "CREATE TABLE IF NOT EXISTS " + TABLE + "(Frm VARCHAR(255),UserID INT(20),Username VARCHAR(255), UNSIGNED,GameMode INT(1) UNSIGNED, Time DATETIME)ENGINE=InnoDB DEFAULT CHARSET=utf8;";
